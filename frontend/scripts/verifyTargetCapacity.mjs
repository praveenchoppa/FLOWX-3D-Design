...
// ── Preview ──────────────────────────────────────────────────────────────────
const preview = computeCapacityPreview(ready, projectDefaults, pa);
...
const layout = generateMultiAreaPanelLayout(ready, projectDefaults, [pa], {
...
const exceedsDefaults = {
  ...projectDefaults,
  designGoal: { type: "capacity", targetCapacityKW: exceedsTargetKW },
};
const exceedsPreview = computeCapacityPreview(ready, exceedsDefaults, pa);
...
const exceedsLayout = generateMultiAreaPanelLayout(ready, exceedsDefaults, [pa], {
  generateMode: GENERATE_MODES.CAPACITY,
});
...
const maxLayout = generateMultiAreaPanelLayout(ready, exceedsDefaults, [pa], {
